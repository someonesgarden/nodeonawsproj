...
==================
  ...
  * Warn for `:` that is not followed by a space ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix #1794 (a bizzare bug with a certain combination of inheritance, mixins and &attributes) ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Add `compileClientWithDependenciesTracked` ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Support comments in `case` blocks ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix blocks in nested mixins ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
==================
  ...
  * Fix `--watch` sometimes dying when there were file-system errors ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
==================
  ...
  * Prevent some compiler errors being silenced ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove use of non-standard `string.trimLeft()` ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix bug in CLI when no name was provided for child template ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove dependency on monocle (hopefully fixing installation on 0.8) ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Add gitter chat room ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
==================
  ...
  * Warn about future change to ISO 8601 style dates ([@TimothyGu](https://github.com/TimothyGu) and [@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  ...
  * Add support for an object in the style attribute ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Add support for an object in the class attribute ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Ignore fs module in browser builds ([@sokra](https://github.com/sokra))
  * Update dependencies ([@hildjj](https://github.com/hildjj))
  * Check mixin arguments are valid JavaScript expressions ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove symlink ([@slang800](https://github.com/slang800))

1.7.0 / 2014-09-17
==================

  * Add Doctype option on command line ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Support ES6 style rest args in mixins ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  ...
  * Lots of new documentation ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
==================
  ...
  * Fix mixins not working at end of file ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix error reporting when mixin block was followed by blank lines ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))


1.5.0 / 2014-07-23
==================

  * Added compileFile API ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix line number in un-used blocks warning ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
==================
  ...
  * Support custom names for client side templates ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/) and [@dscape](https://github.com/dscape))
  ...
  * Track dependencies so file watchers can be more clever ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/) and [@sdether](https://github.com/sdether))
  * Allow passing options to filtered includes ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix bugs with indentation in filters ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/) and [@lackac](https://github.com/lackac))
  * Warn on block names that are never used ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.3.1 / 2014-04-04
==================

  * Fix error with tags in xml that are self-closing in html ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix error message for inline tags with content ([@hiddentao](https://github.com/hiddentao))

1.3.0 / 2014-03-02
==================

  * Fix a bug where sometimes mixins were removed by an optimisation even though they were being called ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/), reported by [@leider](https://github.com/leider))
  * Updated with to support automatically detecting when a value is "global" and removed redundant `options.globals` option ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Improve warnings for tags with multiple attributes ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Deprecate (with a warning) `node.clone`, `block.replace`, `attrs.removeAttribute`, `attrs.getAttribute` - these are all internal APIs for the AST ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.2.0 / 2014-02-26
==================

  * Use variables instead of properties of jade, improving performance and reliability with nested templates ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Support compiling templates from stdin via a user typing ([@yorkie](https://github.com/yorkie))
  * Lazily add mixins ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix case fall-through ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Earlier errors for `when` without `case` and `else` without `if` ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  ...
  * Add and improve test coverage using istanbul ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
==================
  ...
  * Fix a corner case where a mixin was called with `&attributes` but no other attributes and a block that was supposed to be fixed in 1.1.4 ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.1.4 / 2014-01-09
==================

  * Fix a corner case where a mixin was called with `&attributes` but no other attributes and a block ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
==================
  ...
  * Fix same interaction of `&attributes` with `false` `null` or `undefined` but combined with dynamic attributes ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.1.1 / 2014-01-09
==================

  * Fix a bug when `&attributes` is combined with static attributes that evaluate to `false` or `null` or `undefined` ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.1.0 / 2014-01-07
==================

  * Fix class merging to work as documented ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Throw an error when the same attribute is duplicated multiple times ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Move more errors into the parser/lexer so they have more info about line numbers ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Support mixin blocks at the end of files ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.0.2 / 2013-12-31
==================

  * Fix a bug when `&attributes` is combined with dynamic attributes ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.0.1 / 2013-12-29
==================

  * Allow self closing tags to contian whitespace ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Allow tags to have a single white space after them ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Support text bodies of tags that begin with `//` rather than treating them as comments ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))

1.0.0 / 2013-12-22
==================

  * No longer support node@0.8 ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Fix error reporting in layouts & includes ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Allow a list of 'globals' to be passed as an array at compile time & don't automatically expose all globals ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Escape apostrophes in data attributes (@qualiabyte)
  * Fix mixin/block interaction ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/) & [@paulyoung](https://github.com/paulyoung))
  * Ignore trailing space after mixin declaration ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Make literal `.` work as expected ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove implicit text only for script/style ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Stop parsing comments and remove support for conditional comments ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Make filtering includes explicit ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove special assignment syntax ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove `!!!` shortcut for `doctype` ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove `5` shorcut for `html` doctype ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove `colons` option from the distant past ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Add a sepatate `compileClient` and `compileFileClient` to replace the `client` option ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove polyfills for supporting old browsers ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Allow interpolation for mixin names ([@jeromew](https://github.com/jeromew)
  * Use `node.type` instead of `node.constructor.name` so it can be minified ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Allow hyphens in filter names ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Throw an error if a self closing tag has content ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Support inline tags ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Replace `attributes` magic attribute with `&attributes(attributes)` ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove automatic tag wrapping for filters, you can just put the tags in yourself now ([@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Remove whitespace from tags nested inside pre tags ([@markdalgleish](http://markdalgleish.com))

0.35.0 / 2013-08-21
===================

  * Add support for space separated attributes (thanks to [@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * Add earlier errors for invalid JavaScript expressions (thanks to [@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
...
===================
  ...
  * callbacks are optional and leaving them out results in synchronous operation (thanks to [@ForbesLindesay](http://www.js.forbeslindesay.co.uk/))
  * empty filter nodes are now permitted (thanks to [@coderanger](https://github.com/coderanger))
  * overhaul website and documentation (thanks to [@ForbesLindesay](http://www.js.forbeslindesay.co.uk/)), much more of this to come.
