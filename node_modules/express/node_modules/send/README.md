...
Looking to serve up entire folders mapped to URLs? Try [serve-static](https://www.js.npmjs.org/package/serve-static).
...
[ms](https://www.js.npmjs.org/package/ms#readme) module.
...
var app = http.createServer(function(req, res){
  ...
  // /www.js/example.com/public/*
  send(req, url.parse(req.url).pathname, {root: '/www.js/example.com/public'})
  .on('error', error)
